...
adams_path = r"C:\Users\kaspe\OneDrive - Aarhus universitet\6. semester\Bachelorprojekt\Adams\dp_adams_results.csv"

adams_comp_pend(filename2, adams_path, plot_diff=True)

adams_delta_pend(filename2,adams_path)