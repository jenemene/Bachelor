...
class MultiBodySystem:
    ...
    def unpack_state(self,state):
        ...
        for link in self.links:
            ...
            if link.joint.nq == 4: # Spherical
                theta = theta / np.linalg.norm(theta)
            elif link.joint.nq == 7: # Free
    ...
    def get_state_dot_closed(self,t,state,V_base,A_base,BG_params):
        ...
        Λ_n1 = IRn @ (omega_n1 @ link1.RBT) @ IR1.T
    ...
    def get_state_dot_multiple_constraints(self,t,state,V_base,A_base,BG_params):
        ...
        # Λ_31: Left frame is n(3), Right frame is 1
        Λ_31 = IRn @ (Ω_31 @ link1.RBT) @ IR1.T
        # Λ_13: Left frame is 1, Right frame is n(3)
        Λ_13 = IR1 @ (link1.RBT.T @ Ω_31.T) @ IRn.T

        #constraint 2 - driver. Driving the base of the link here
        Λ_22 = IR2 @ (Ω_22 @ IR2.T)

        #cross couplings
        # Λ_21: Left frame is 2, Right frame is 1
        Λ_21 = IR2 @ (Ω_21 @ link1.RBT) @ IR1.T
        # Λ_12: Left frame is 1, Right frame is 2
        Λ_12 = IR1 @ (link1.RBT.T @ Ω_21.T) @ IR2.T
        
        # Λ_32: Left frame is n(3), Right frame is 2
        Λ_32 = IRn @ Ω_32 @ IR2.T
        # Λ_23: Left frame is 2, Right frame is n(3)
        Λ_23 = IR2 @ Ω_32.T @ IRn.T
