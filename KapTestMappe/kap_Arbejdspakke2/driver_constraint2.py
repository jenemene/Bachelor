...
joint4.q_init = SOA.quatfromrev(2*np.pi/5,"y")
joint3.q_init = SOA.quatfromrev(2*np.pi/5,"y")
joint2.q_init = SOA.quatfromrev(2*np.pi/5,"y")
joint1.q_init = SOA.quatfromrev(2*np.pi/5,"y")
...
robot.simulate(tspan,V_base,A_base,config="pentagon",BG_params=[50,200])
