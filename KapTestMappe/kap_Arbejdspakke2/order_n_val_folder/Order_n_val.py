...
n_bodies_list = [1] + list(range(5, 101, 5))
repeats = 10
...
with open(csv_filename, mode='w', newline='') as file:
    ...
    writer.writerow(["Num_Bodies", "Run_Index", "Solver_RK4_Time", "Solver_RK45_Time"])
    ...
    for n_bodies in n_bodies_list:
        ...
        for r in range(repeats):
            ...
            pend.simulate(tspan, V_base, A_base, "open")
            ...
            writer.writerow([n_bodies, r + 1, t_rk4, t_rk45])
